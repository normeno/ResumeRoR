class BootstrapFormBuilder < ActionView::Helpers::FormBuilder
    ...
    def bootstrap_hidden_field(method, options = {})
      @template.content_tag(
        :div,
        hidden_field(method, options.merge(class: 'form-control')),
        :class => 'form-group'
      )
    end
    ...
    def bootstrap_year_picker(method, options = {})
      @template.content_tag(
        :div,
        text_field(method, options.merge(class: 'form-control yearpicker', 'data-provide': 'datepicker')),
        :class => 'form-group'
      )
    end

    def bootstrap_month_picker(method, options = {})
      @template.content_tag(
        :div,
        text_field(method, options.merge(class: 'form-control monthpicker', 'data-provide': 'datepicker')),
        :class => 'form-group'
      )
    end

    def bootstrap_date_picker_empty(method, options = {})
      @template.content_tag(
        :div,
        date_field(method, options.merge(class: 'form-control datepicker', 'data-provide': 'datepicker')),
        :class => 'form-group'
