...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { career: @education.career, end: @education.end, entity_name: @education.entity_name, person_id: @education.person_id, start: @education.start }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { career: @education.career, end: @education.end, entity_name: @education.entity_name, person_id: @education.person_id, start: @education.start }
    assert_redirected_to education_path(assigns(:education))
  end
